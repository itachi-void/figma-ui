        ...
        >
          ...
          <ResponsiveContainer width="100%" height={300}>
            <AreaChart data={weeklyData}>
              <defs>
                <linearGradient id="importsColorCollected" x1="0" y1="0" x2="0" y2="1">
                  <stop offset="5%" stopColor="#10B981" stopOpacity={0.3}/>
                  <stop offset="95%" stopColor="#10B981" stopOpacity={0}/>
                </linearGradient>
                <linearGradient id="importsColorProcessed" x1="0" y1="0" x2="0" y2="1">
              ...
              <Area 
                ...
                stroke="#10B981" 
                fillOpacity={1} 
                fill="url(#importsColorCollected)" 
                strokeWidth={2}
              />
              <Area 
                type="monotone" 
                ...
                stroke="#3B82F6" 
                fillOpacity={1} 
                fill="url(#importsColorProcessed)" 
                strokeWidth={2}
              />
            </AreaChart>
          </ResponsiveContainer>
