...
// Sample Data
const monthlyData = [
  { month: 'Jan', collections: 4200, revenue: 8400, recycled: 3900, efficiency: 92 },
  { month: 'Feb', collections: 4800, revenue: 9600, recycled: 4500, efficiency: 94 },
  { month: 'Mar', collections: 5200, revenue: 10400, recycled: 4900, efficiency: 94 },
  { month: 'Apr', collections: 5800, revenue: 11600, recycled: 5500, efficiency: 95 },
  { month: 'May', collections: 6200, revenue: 12400, recycled: 5900, efficiency: 95 },
  { month: 'Jun', collections: 6800, revenue: 13600, recycled: 6500, efficiency: 96 },
  { month: 'Jul', collections: 7200, revenue: 14400, recycled: 6900, efficiency: 96 },
  { month: 'Aug', collections: 7600, revenue: 15200, recycled: 7300, efficiency: 96 },
  { month: 'Sep', collections: 8100, revenue: 16200, recycled: 7800, efficiency: 96 },
...
const regionData = [
  ...
  { region: 'Central', bottles: 3100, centers: 12, drivers: 36 },
];

const topDrivers = [
  { id: 1, name: 'Ahmed Hassan', collections: 1240, revenue: 2480, rating: 4.9, badge: 'gold' },
  { id: 2, name: 'Mohamed Ali', collections: 1180, revenue: 2360, rating: 4.8, badge: 'gold' },
  { id: 3, name: 'Sara Ahmed', collections: 1120, revenue: 2240, rating: 4.7, badge: 'silver' },
  { id: 4, name: 'Omar Khaled', collections: 1050, revenue: 2100, rating: 4.7, badge: 'silver' },
  { id: 5, name: 'Fatima Said', collections: 980, revenue: 1960, rating: 4.6, badge: 'bronze' },
];

const recentActivities = [
  { id: 1, action: 'New Collection', user: 'Ahmed Hassan', location: 'North District', time: '2 min ago', status: 'success' },
  { id: 2, action: 'Route Completed', user: 'Mohamed Ali', location: 'East District', time: '15 min ago', status: 'success' },
  { id: 3, action: 'Maintenance Alert', user: 'System', location: 'Central Hub', time: '1 hour ago', status: 'warning' },
  { id: 4, action: 'Quality Check', user: 'Sara Ahmed', location: 'South Center', time: '2 hours ago', status: 'success' },
  { id: 5, action: 'Inventory Update', user: 'System', location: 'West Warehouse', time: '3 hours ago', status: 'info' },
];
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-4">
        {stats.map((stat, index) => {
          ...
          return (
            ...
            >
              {/* Background Gradient */}
              <div className={`absolute top-0 right-0 w-24 h-24 bg-gradient-to-br ${stat.color} opacity-5 rounded-full -mr-12 -mt-12 group-hover:opacity-10 transition-opacity`} />
        ...
        >
          <div className="flex items-center justify-between mb-6">
            <div>
              ...
              <p className="text-sm text-gray-600 mt-1">Breakdown by material type</p>
            </div>
          </div>
        ...
        >
          <div className="flex items-center justify-between mb-6">
            <div>
              ...
              <p className="text-sm text-gray-600 mt-1">Analysis by geographic region</p>
            </div>
          </div>
          ...
          <ResponsiveContainer width="100%" height={300}>
            <RechartsBarChart data={regionData}>
              ...
              />
              <Legend />
              <Bar dataKey="bottles" fill="#F59E0B" radius={[8, 8, 0, 0]} name="Bottles Collected" />
              <Bar dataKey="centers" fill="#8B5CF6" radius={[8, 8, 0, 0]} name="Centers" />
              <Bar dataKey="drivers" fill="#3B82F6" radius={[8, 8, 0, 0]} name="Drivers" />
            </RechartsBarChart>
          </ResponsiveContainer>
        </motion.div>
      </div>
      ...
      >
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            <p className="text-sm text-gray-600 mt-1">Year-over-year performance improvement</p>
          </div>
        </div>
        ...
        >
          <div className="flex items-center justify-between mb-6">
            <div>
              ...
              <p className="text-sm text-gray-600 mt-1">Leading drivers this month</p>
            </div>
          </div>
        ...
        >
          <div className="flex items-center justify-between mb-6">
            <div>
              ...
              <p className="text-sm text-gray-600 mt-1">Live system updates</p>
            </div>
            <motion.button
          ...
          <div className="space-y-3">
            {recentActivities.map((activity, index) => {
              ...
              return (
                ...
                >
                  <div className={`w-8 h-8 rounded-lg flex items-center justify-center border ${statusColors[activity.status as keyof typeof statusColors]}`}>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        >
          ...
          <h3 className="text-lg font-semibold mb-2">Collection Goal</h3>
          <p className="text-3xl font-bold mb-2">87%</p>
          <p className="text-blue-100 text-sm">Target: 100,000 bottles</p>
        ...
        >
          ...
          <p className="text-purple-100 text-sm">Active user retention rate</p>
          <div className="mt-4 flex items-center gap-2">
            <CheckCircle className="w-5 h-5" />
            <span className="text-sm font-medium">11,806 active users</span>
          </div>
        </motion.div>
      </div>
