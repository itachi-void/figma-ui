...
export default function Resources() {
  const [activeTab, setActiveTab] = useState<'assets' | 'hr' | 'financial'>('assets');
    ...
    <div className="space-y-6">
      ...
      >
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-600 mt-1">Manage assets, HR, and financial resources</p>
          </div>
      ...
      >
        <nav className="-mb-px flex space-x-8">
          {[
            { id: 'assets', label: 'Asset Tracking', icon: Package },
              ...
              {[
                ...
                return (
                  ...
                  >
                    ...
                    {stat.subtitle && (
                      <p className="text-xs text-gray-500 mt-2">{stat.trend} {stat.subtitle}</p>
                    )}
                  </motion.div>
                );
              })}
                ...
                <table className="w-full">
                  ...
                  <tbody className="divide-y divide-gray-200">
                    {[
                      {
                        id: 'TXN-001',
                        description: 'Bottle Collection Revenue',
