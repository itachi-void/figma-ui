...
export default function Overview() {
  ...
  > = {
    ...
    manager: {
      ...
      subtitle: "Your team's progress and resource allocation",
    },
    driver: {
      title: "My Dashboard",
      subtitle: "Your daily tasks and route information",
    },
    citizen: {
      title: "My Recycling Hub",
      subtitle: "Track your contributions and earn rewards",
    },
  };
  ...
  const handleQuickAction = async (actionName: string) => {
    ...
    try {
      ...
      const activityMessages: Record<
        string,
        { action: string; details: string; severity: string }
      > = {
        "Optimize All Routes": {
          action: "Routes Optimized",
          details:
            "8 routes optimized, saved 15% distance, ETA reduced by 45 minutes",
          severity: "low",
        },
        "Assign New Driver": {
        ...
        "My Stats": {
          ...
          details:
            "Rating: 4.8/5 ⭐, Completed: 156 collections, Efficiency: 94%",
          severity: "low",
        },
        "Report Issue": {
      ...
      if (message && logActivity) {
        logActivity({
          ...
          target: "System",
          category: actionName.includes("Route")
            ? "route"
      ...
      ? [
          {
            ...
            description: "Schedule bottle collection",
          ...
          },
          {
            icon: Award,
            title: "My Rewards",
            description: "View points & badges",
