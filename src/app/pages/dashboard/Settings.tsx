            ...
            >
              ...
              <div className="space-y-4">
                {[
                  ...
                  { key: 'sms', label: 'SMS Notifications', desc: 'Receive SMS text messages' },
                ].map((item) => (
                  <div key={item.key} className="flex items-center justify-between p-4 border border-gray-200 rounded-xl hover:bg-gray-50 transition-colors">
                    <div>
                    ...
                    >
                      <motion.div
                        ...
                        animate={{
                          x: notifications[item.key as keyof typeof notifications] ? 28 : 4,
                        }}
