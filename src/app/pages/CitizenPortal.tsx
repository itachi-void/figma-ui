    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="container mx-auto px-4 py-8">
        <div className="mb-8">
          ...
          <p className="text-gray-600">Track your recycling activity and rewards</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-white p-8 rounded-lg shadow-sm text-center">
            ...
            <h2 className="text-xl font-semibold text-gray-900 mb-2">Scan Bottle</h2>
            <p className="text-gray-600 mb-4">Scan QR code to register recycled bottles</p>
          ...
          <div className="bg-white p-8 rounded-lg shadow-sm text-center">
            ...
            <h2 className="text-xl font-semibold text-gray-900 mb-2">Redeem Rewards</h2>
          ...
          <div className="space-y-4">
            {[
              ...
              <div key={index} className="flex items-center justify-between pb-4 border-b last:border-0">
                ...
                <div className="text-right">
                  <p className="text-sm font-semibold text-green-600">+{activity.points} points</p>
                </div>
              </div>
            ))}
          </div>
