  ...
  return (
    <div ref={ref} className="relative">
      ...
      >
        ...
        {totalUnread > 0 && (
          <span className={`absolute -top-1 -right-1 w-5 h-5 bg-green-500 text-white text-xs rounded-full flex items-center justify-center font-bold transition-all ${isVisible ? 'scale-100' : 'scale-0'}`}>
          ...
          {!currentConv ? (
            ...
            <div className="flex flex-col h-full">
              ...
              <div className="flex items-center gap-3 px-3 py-3 border-b border-gray-100 bg-gray-50">
                <button onClick={() => setActiveConv(null)} className="p-1.5 hover:bg-gray-200 rounded-lg transition-colors">
              ...
              <div className="flex-1 overflow-y-auto px-3 py-3 space-y-2">
                {currentConv.messages.map((msg) => {
                  ...
                  return (
                    <div
                      key={msg.id}
                      className={`flex ${isAdmin ? 'justify-end' : 'justify-start'} animate-[fadeInUp_0.3s_ease-out]`}
                    >
              ...
              <div className="px-3 py-3 border-t border-gray-100">
                <div className="flex gap-2">
                  ...
                  <button
                    ...
                    className="p-2 bg-green-600 text-white rounded-xl hover:bg-green-700 transition-all disabled:opacity-50 hover:scale-105 active:scale-95"
                  >
