...
(function () {
  ...
  var noop = function () {};
  var noopReturnsFalse = function () {
    return false;
  };
  var noopReturnsNull = function () {
    return null;
  };
  var noopReturnsTrue = function () {
    return true;
  };
  var noopReturnsMap = function () {
    return new Map();
  };
  var noopReturnsSet = function () {
    return new Set();
  };
  var noopReturnsEmptyArray = function () {
    return [];
  };
  var noopReturnsEmptyObject = function () {
    return {};
  };
  ...
  const isWritable = (() => {
    try {
      Object.defineProperty(window, "__TEST_WRITABLE__", { value: true });
      delete window.__TEST_WRITABLE__;
      return true;
    } catch {
      return false;
    }
  ...
  if (isWritable) {
    try {
      ...
      console.warn(
        "[DevTools Blocker] Failed to use defineProperty, using fallback...",
      );
      try {
        window.__REACT_DEVTOOLS_GLOBAL_HOOK__ = devtoolsHook;
      } catch (e) {
        console.warn(
          "[DevTools Blocker] Entirely failed to define hook (likely read-only environment like Figma). Skipping gracefully.",
        );
      }
    }
  } else {
  ...
  Object.defineProperty = function (obj, prop, descriptor) {
    if (obj === window && prop === "__REACT_DEVTOOLS_GLOBAL_HOOK__") {
      console.warn(
        "[DevTools Blocker] Blocked attempt to redefine DevTools hook",
      );
      return obj;
    }
